...
public class ChessGame {
    ...
    public static void start(Player p1, Player p2) throws IOException {
        pl1 = p1;
        pl2 = p2;
        if (pl1.getColor().equals("White")) {
            pl1.kx = 4;
            pl1.ky = 7;
            pl2.kx = 4;
            pl2.ky = 0;
        ...
        // il faut changer le path d'image 
        BufferedImage all = ImageIO.read(new File("C:\\Users\\ahmed\\Documents\\NetBeansProjects\\chessGame\\src\\chess\\chessboard.png"));
